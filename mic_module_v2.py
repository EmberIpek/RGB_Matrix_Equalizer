...
def setup(Rpin, Gpin, Bpin, Rpin2, Gpin2, Bpin2, Rpin3, Gpin3, Bpin3):
	global pins
	global pins2
	global pins3
	...
	pins3 = {'pin_R2': Rpin3, 'pin_G2': Gpin3, 'pin_B2': Bpin3}
	...
	p_R3 = GPIO.PWM(pins3['pin_R2'], 2000)  # set PWM frequency to 2KHz
	p_G3 = GPIO.PWM(pins3['pin_G2'], 2000)
	p_B3 = GPIO.PWM(pins3['pin_B2'], 2000)
...
def setColor3(col):
	...
	p_R3.ChangeDutyCycle(100-R_val)     # Change duty cycle
	p_G3.ChangeDutyCycle(100-G_val)
	p_B3.ChangeDutyCycle(100-B_val)
...
def read_pcf8591(channel):
	bus.write_byte(address, 0x40 | channel)  # 0x40 + channel
...
def loop():
	while True:
		...
		color1 = distance_to_color(norm_high, 1.0)
		color2 = distance_to_color(norm_mid, 1.0)
		color3 = distance_to_color(norm_low, 1.0)
